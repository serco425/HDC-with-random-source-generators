...
total_test_size_CONV = 1;

WaitMessage = parfor_wait(total_test_size_CONV, 'Waitbar', true);

%LFSR_8192-BASED CONVENTIONAL HDC
SIMPLE_UPDATE_langRecognition_LFSR_8192();
...
clearvars -except accuracyCONV AVG_CONV MIN_CONV MAX_CONV STDDEV_CONV total_test_size_SC
